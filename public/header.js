        ...
        headerContainer.innerHTML =`
            <div class="top" id="top">
                ...
                <div class="secondary-navigation">
                    ...
                    <div class="navbar">
                        <ul>
                            ...
                            <li><strong><a href="my-profile.html" id="loginProfile1">Profile</a></strong></li>
                        </ul>
                    </div>
                    <div style="min-width: 10px"></div>
                </div>
                ...
                <div class="header">
                    ...
                    <div class="navbar">
                        <ul>
                            ...
                            <li><a href="map.html">SwapSpots</a></li>
                ...
                <div class="menu" id="menu">
                    ...
                    <br>
                    <a href="my-profile.html" id="Profile"></a>
                    <br>
                    <li><a href="#" id="logout-link">Log Out</a></li>
                    <br>
                    <form action="find.html" id="search2"> <!-- May change page name -->
                        <input type="text" placeholder="Search books" name="search">
                        <button type="submit"><i class="fa fa-search"></i></button>
                    </form>
                </div>
        ...
        document.body.insertBefore(header, document.body.firstChild);
            ...
            <div class="top" id="top">
                ...
                <div class="menu" id="menu">
                    ...
                    <a href="subscription.html">Subscriptions</a>
                    <br>
                    <a href="login.html.html" id="Login"></a>
                    <br>
                    <form action="find.html" id="search2"> <!-- May change page name -->
                        <input type="text" placeholder="Search books" name="search">
                        <button type="submit"><i class="fa fa-search"></i></button>
